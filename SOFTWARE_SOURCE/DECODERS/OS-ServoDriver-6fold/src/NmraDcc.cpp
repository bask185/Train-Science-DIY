...
//            2015-12-16 Version without use of Timer0 by Franz-Peter M�ller
...
/*
    ...
    else if ( (DccProcState.Flags & FLAGS_MY_ADDRESS_ONLY) && (Addr != getMyAddr()) && (Addr != 0))// SK: disabled this, not needed
       return ;*/

    CmdMasked &= 0b11100000 ; // SK clear this flag so our decoder listens to all packets
