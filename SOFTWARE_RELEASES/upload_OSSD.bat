...
:retry
echo UPLOADING OSSD.hex on %comPort%

tools\avrdude -C tools\avrdude.conf -v -V -p atmega328p -c stk500v1 -P \\.\%comPort% -b 19200  -U flash:w:bin\OSSD.hex:i -U lock:w:0x3F:m -U efuse:w:0xFD:m -U hfuse:w:0xDA:m -U lfuse:w:0xFF:m
